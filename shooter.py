...
greande_box_img = pygame.image.load('img/icons/grenade_box.png').convert_alpha()


item_boxes = {
    'Health'  : heal_box_img,
    'Ammo'    : ammo_box_img,
    'Grenade' : greande_box_img   
}
...
def draw_bg():
    ...
    for x in range(5):
        ...
        screen.blit(pine1_img , ((x * width) - bg_scroll * 0.6, SCREEN_HEIGHT - mountain_img.get_height() - 150))
...
class Soldier(pygame.sprite.Sprite):    
    ...
    def move(self, moving_left, moving_right):
        ...
        for tile in world.obstacle_list:
            ...
            if tile[1].colliderect(self.rect.x + dx , self.rect.y , self.width , self.height):
                dx = 0
                # if ai hit a wall then turn around 
            ...
            if tile[1].colliderect(self.rect.x  , self.rect.y + dy , self.width , self.height):
                ...
                # checck if above the ground i.e falling
                elif self.vel_y >= 0:
                    self.vel_y = 0
                    self.in_air = False
    ...
    #    check if going off the edges of the screen
        ...
        # update scroll upon player position
        if self.char_type == 'player':
    ...
    def ai(self):
        if self.alive and player.alive:
            ...
            # Checking if ai is near the player
            if self.vision.colliderect(player.rect):
                ...
                if self.idling == False:
                    ...
                    self.update_action(1) # 1 is for running
                    self.move_counter += 1
                    # AI vision for enemey moves
...
class World():
    ...
    def process_data(self, data):
        ...
        # iterating through each value in level data file
...
class ItemBox(pygame.sprite.Sprite):
    ...
    def update(self):
        # scroll
        self.rect.x += screen_scroll
        # check if the player has either picked the box
        if pygame.sprite.collide_rect(self,player):
            #checking the box kind
            if self.item_type == 'Health':
                ...
                player.grenades += 3
            # remove the item frame after it has been picked up
            self.kill()
...
class Grenade(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.timer <= 0:
            ...
            # do damage by grenade to nearest character
...
class Explosion(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.counter >= EXPLOSION_SPEED:
            self.counter = 0
            self.frame_index +=1
            # when animation is complete delete the animation
...
class ScreenFade():
    ...
    def fade(self):
        ...
        if self.direction == 2: # vertical screen ko fade
...
while run:
    ...
    if start_game == False:
        ...
        if player.alive:
            ...
            if player.in_air:
                player.update_action(2)#2 = this is for jump
